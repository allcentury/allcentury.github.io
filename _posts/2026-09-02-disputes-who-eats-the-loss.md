---
layout: post
title: "The chargeback: who eats the loss, and why"
...
The second big scenario is a "never received it" dispute, and this is the one that catches merchants off guard because there's no elegant liability-shift rule here. There's just evidence, or the lack of it. If you can't prove delivery, you lose, full stop, regardless of whether the customer is telling the truth or not.
...
$228.87 lost on a $129 sale, 1.77x the original transaction. That's not even the worst case, [Chargeback Gurus puts it at more than double](https://www.chargebackgurus.com/blog/chargeback-fees-the-true-cost-of-your-chargebacks) once everything's factored in, "a $100 chargeback can cost a business over $200." The chargeback fee alone is worth calling out, it's non-refundable even if the merchant fights the dispute and wins later. Winning gets you your $129 back. It does not get you your $15 back, and on some smaller transactions, $15 might be greater than your actual margin.
